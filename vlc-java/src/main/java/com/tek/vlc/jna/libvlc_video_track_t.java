...
public class libvlc_video_track_t extends Structure {
    ...
    protected List<? > getFieldOrder() {
        return Arrays.asList("i_height", "i_width", "i_sar_num", "i_sar_den", "i_frame_rate_num", "i_frame_rate_den");
    }
    public libvlc_video_track_t(int i_height, int i_width, int i_sar_num, int i_sar_den, int i_frame_rate_num, int i_frame_rate_den) {
        super();
